...
AVES = Oiler.VelocityVectorSphere(lond = -63.62, latd = 15.67, ve = 13.2, vn =
14.2, ee = 2.9, en = 2.2, fix = "na", mov = "ca");
ROJO = Oiler.VelocityVectorSphere(lond = -71.67, latd = 17.90, ve = 13.5, vn =
6.90, ee = 3.0, en = 2.6, fix = "na", mov = "ca");
SANA = Oiler.VelocityVectorSphere(lond = -81.73, latd = 12.53, ve = 14.8, vn =
7.4, ee = 2.7, en = 2.5, fix = "na", mov = "ca");
CRO1 = Oiler.VelocityVectorSphere(lond = -64.58, latd = 17.76, ve = 9.80, vn =
...
lons, lats = Oiler.get_coords_from_vel_array(pred_vels)
